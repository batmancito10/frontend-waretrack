...
function PerfilProveedor() {
    ...
    return (
        <div className="container-fluid">
                    ...
                    <div className="row gx-4">
                        <div className="col-auto">
                            <div className="avatar avatar-xl position-relative">
                                <img src={proveedor.imagen ? proveedor.imagen : 'https://cdn1.iconfinder.com/data/icons/programing-development-8/24/react_logo-512.png'} alt="profile_image" className="w-100 border-radius-lg shadow-sm" />
                            </div>
                        </div>
                            ...
                            <div className="nav-wrapper position-relative end-0">
                                <ul className="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                    <li className="nav-item">
                                        <a className="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="#" role="tab" aria-selected="true" onClick={handleInput}>
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link mb-0 px-0 py-1 " data-bs-toggle="modal" data-bs-target="#exampleModal" href="#" role="tab" aria-selected="false">
            ...
            <EliminarProveedor idProveedor={idProveedor} nombreProveedor={nombreProveedor}></EliminarProveedor>
        </div>
    );
}
