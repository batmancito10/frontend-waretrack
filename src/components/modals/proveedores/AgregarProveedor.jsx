                ...
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div className="modal-content">
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        <div className="d-flex gap-2 align-items-center justify-content-between">
                                            ...
                                            <input className="form-control w-65" type="text" name="first-name" value={nombre} onChange={handleChangeNombre}/>
                                    ...
                                    <div className="col-md-6">
                                        <div className="d-flex gap-2 align-items-center justify-content-between">
                                            ...
                                            <input className="form-control w-65" type="email" name="email" value={email} onChange={handleChangeEmail}/>
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6">
                                        <div className="d-flex gap-2 align-items-center justify-content-between">
                                            ...
                                            <input type="text" name="direccion" className="form-control w-65" value={direccion} onChange={handleChangeDireccion}/>
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="col-md-6">
                                        <div className="d-flex gap-2 align-items-center justify-content-between">
                                            ...
                                            <input className="form-control w-65" type="text" name="telefono" min="0" value={telefono} onChange={handleChangeTelefono}/>
                        ...
                        <div className="modal-footer">
                            ...
                            <button className="btn btn-primary" type="submit" form="AgregarUsuario" data-bs-dismiss="modal" onClick={agregarProveedorRequest}>Agregar proveedor</button>
                        </div>
                    </div>
                </div>
            </div>
