...
function FormUsuario({
  ...
  return (
    <form role="form text-left" id={`${id}Usuario`} onSubmit={onSubmit}>
      <div className="row mb-3">
        <div className="col-md-6">
          <div className="d-flex gap-2 align-items-center justify-content-between">
            <label htmlFor={`${id}First-name`} className="fs-6 pt-1">
              Nombres
            </label>
            <input
        ...
        <div className="col-md-6">
          <div className="d-flex gap-2 align-items-center justify-content-between">
            <label htmlFor={`${id}Last-name`} className="fs-6 pt-1">
              Apellidos
            </label>
            <input
      ...
      <div className="row mb-3">
        <div className="col-md-6">
          <div className="d-flex gap-2 align-items-center justify-content-between">
            <label htmlFor={`${id}Email`} className="fs-6 pt-1">
              Email
            </label>
            <input
              value={values['email']}
        ...
        <div className="col-md-6 password">
          <div className="d-flex gap-2 align-items-center justify-content-between">
            <label htmlFor={`${id}Password`} className="fs-6 pt-1">
              Contraseña
            </label>
            <div className="input-group w-65 ">
              <input
                ...
                type="password"
                name="password"
                required={id === 'Agregar' && true}
                onChange={inputHandler('password')}
                id={`${id}Password`}
              />
              <button
                className="btn btn-outline-primary mb-0 fs-5 px-3 py-0"
                type="button"
                onClick={togglePassword}
                id={`${id}PasswordButton`}
              >
      ...
      <div className="row mb-3">
        ...
        <div className="col-md-6">
          <div className="d-flex gap-2 align-items-center justify-content-between">
            <label htmlFor={`${id}Salario`} className="fs-6 pt-1">
              Salario
            </label>
            <input
      ...
      <div className="row">
        <div className="col-md-6">
          <div className="d-flex gap-2 align-items-center justify-content-between">
            <label htmlFor={`${id}Cargo`} className="fs-6 pt-1">
              Cargo
            </label>
            <input
              type="text"
