...
function EditarPedido({
  ...
  const pedidoEspecificoRequest = async () => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_PEDIDO}${pedidoSeleccionadoEditar}/`,
      {
        mode: 'cors',
        method: 'get',
    ...
    const sedeResponse = await fetch(
      `${import.meta.env.VITE_SEDE}${pedidoo.sede}/`,
      {
        mode: 'cors',
        method: 'get',
        headers: { Authorization: `Bearer ${accessToken}` },
    ...
    const funcionarioResponse = await fetch(
      `${import.meta.env.VITE_FUNCIONARIO}${pedidoo.funcionario}/`,
      {
        mode: 'cors',
        method: 'get',
        headers: { Authorization: `Bearer ${accessToken}` },
    ...
    const proveedorResponse = await fetch(
      `${import.meta.env.VITE_PROVEEDOR}${pedidoo.proveedor}/`,
      {
        mode: 'cors',
        method: 'get',
        headers: { Authorization: `Bearer ${accessToken}` },
      ...
      pedidoEspecificoRequest()
        .then((data) => {
          ...
          const dataFuncionario = {
            ...
            label:
              data.funcionario.first_name + ' ' + data.funcionario.last_name,
          };
  ...
  return (
    <div className={showModalEdit ? ' overlay modal_open' : 'overlay'}>
