...
function DetallePedido({
  ...
  const pedidosRequest = async () => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_PEDIDO}${pedidoSeleccionadoDetalle}/`,
      {
        mode: 'cors',
        method: 'get',
  ...
  return (
    <>
      <div className={showModalDetail ? ' overlay modal_open' : 'overlay'}>
            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="form-group d-flex">
                  ...
                  >
                    <h6 className="mb-0">
                      {pedidoDetalle.funcionario?.first_name +
                        ' ' +
                        pedidoDetalle.funcionario?.last_name}
                    </h6>
                  </div>
                </div>
                <div className="form-group d-flex">
