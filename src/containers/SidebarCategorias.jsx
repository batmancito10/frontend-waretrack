...
function SidebarCategorias({
  ...
  const categoriaRequest = async () => {
    const response = await fetch(
      `${import.meta.env.VITE_CATEGORIA}${categoriaSeleccionada}/`,
      {
        mode: 'cors',
        method: 'get',
                    ...
                    <div className="badge-colors my-2 text-start">
                      {colors.map((color) => {
                        return (
                          <div
                            className={`badge filter ${
                              categoria.color === color.hex ? 'active' : ''
                            }`}
                            style={{
              ...
              <div className="float-start">
                ...
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    className="form-control"
                    onChange={handleInputChangeAgregar}
                    id="nombre"
                    name="nombre"
                  ...
                  {colors.map((color) => {
                    return (
                      <div
                        ...
                        onClick={() => handleColorClickAgregar(color)}
                        key={color.hex}
                      ></div>
                    );
                  })}
